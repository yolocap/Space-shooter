...
var goWav = 'wav/gameover.wav';
var staWav = 'wav/start.wav';
var exWav = 'wav/explode.wav';
var bgWav = 'wav/bg.wav';
var shoWav = 'wav/shoot.wav';
	...
	initialize: function(x, y) {
		...
		this.addEventListener('enterframe', function() {
			if (player.within(this, 8)){ // 	bullet has hit player
				...
				game.assets[bgWav].stop();
				game.assets[goWav].play();
...
window.onload = function() {
	...
	game.fps = 24;
	game.score = 0;
	game.preload(graImg, effImg, bgImg, goWav, staWav, exWav, bgWav, shoWav);
	game.touched = false;
